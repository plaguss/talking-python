"""Tests to see how summarizing a whole document works."""
...
models = [
    ("philschmid/bart-large-cnn-samsum", 1024, (56, 142)),  # (56, 142)
    ("philschmid/flan-t5-base-samsum", 512, (30, 200)),  # (30, 200)
